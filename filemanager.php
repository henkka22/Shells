...
if (isset($_GET['dl'])) {
    ...
    if ($dl != '' && is_file($path . '/' . $dl)) {
        ...
        exit;
    } else {fm_set_msg(lng('File not found'), 'error');
        fm_redirect(FM_SELF_URL . '?p=' . urlencode(FM_PATH));
    }
}
...
if (isset($_GET['view'])) {
    ...
    ?>
    <div class="row">
        <div class="col-12"><?php if(!$quickView) { ?>
